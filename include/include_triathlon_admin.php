            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        <div class="flex items-center">
                            <h3 class="text-gray-700 text-3xl font-medium mr-2">Gérer les Triathlons</h3>
                            <a class="mt-2" href="add_triathlon_admin.php">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                    DATE TRIATHLON </th>
                                                <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                    DISTANCE NATATION </th>
                                                <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                    DISTANCE CYCLISME </th>
                                                <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                    DISTANCE COURSE A PIED </th>
                                                <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                    Editer </th>
                                            </tr>
                                        </thead>
                                        <?php foreach ($all_triathlon as $all_triathlons) : ?>
                                            <tbody class="bg-white">
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 font-medium text-gray-900"> <?= $all_triathlons->nom_triathlon ?></div>
                                                    </td>

                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900"><?= $all_triathlons->lieu_triathlon ?></div>
                                                    </td>

                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900"><?= $all_triathlons->date_triathlon ?></div>
                                                    </td>

                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900"><?= $all_triathlons->distance_natation ?> Km</div>
                                                    </td>

                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900"><?= $all_triathlons->distance_cyclisme ?> Km</div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900"><?= $all_triathlons->distance_course_pied ?> Km</div>
                                                    </td>

                                                    <td class="px-6 py-4 border-b whitespace-no-wrap border-gray-200   ">
                                                        <a href="editer_triathlon_admin.php?id=<?= $all_triathlons->id_triathlon ?>">
                                                        ...
                                                        <a onclick="return confirm('Confirmer la suppression')" type="submit" href="delete_triathlon_admin.php?id=<?= $all_triathlons->id_triathlon ?>">
